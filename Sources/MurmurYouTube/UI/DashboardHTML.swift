...
enum DashboardHTML {
    static func render(runs: [DictationRun], compareMode: Bool = false, key: String = "Right \u{2325}") -> String {
        ...
        <title>Murmure — engine comparison</title>
        <style>
        :root{--bg:#f4f1ec;--panel:#fff;--ink:#25211e;--muted:#716961;--line:#d3ccc4;
              --accent:#d85a3b;--warn:#b57d45;--good:#66816b;}
        @media (prefers-color-scheme:dark){:root{--bg:#0f0f12;--panel:#18181d;--ink:#f2f2f5;
              --muted:#b5aca1;--line:#403a35;--good:#8aa28d;}}
        :root[data-theme="dark"]{--bg:#171615;--panel:#252220;--ink:#f1ebe2;--muted:#b5aca1;--line:#403a35;--good:#8aa28d;}
        :root[data-theme="light"]{--bg:#f4f1ec;--panel:#fff;--ink:#25211e;--muted:#716961;--line:#d3ccc4;--good:#66816b;}
        *{box-sizing:border-box}
        ...
        h1{margin:0 0 4px;font-size:27px;letter-spacing:-.02em;color:var(--ink)}
        ...
        .verdict.diff{background:color-mix(in srgb,var(--warn) 18%,transparent);color:var(--warn)}
