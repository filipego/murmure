    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DS.Space.wide) {
            VStack(alignment: .leading, spacing: DS.Space.tight) {
                Text(original.trigger.isEmpty ? "Add snippet" : "Edit snippet")
                    .font(DS.Font.title)
                    .foregroundStyle(DS.Color.ink)
                Text("Murmure replaces only a complete matching utterance. It never changes a phrase inside ordinary prose.")
                    .font(DS.Font.label)
            ...
            VStack(alignment: .leading, spacing: DS.Space.snug) {
                Text("WHEN I SAY")
                    ...
                    .foregroundStyle(DS.Color.inkSecondary)
                TextField("my address", text: $trigger)
            ...
            VStack(alignment: .leading, spacing: DS.Space.snug) {
                ...
                TextEditor(text: $replacement)
                    ...
                    .disabled(isSaving)
                Text("Line breaks are kept in the inserted text.")
            ...
            HStack(spacing: DS.Space.snug) {
                ...
                Button("Cancel", role: .cancel) { dismiss() }
                    ...
                    .disabled(isSaving)
                Button(isSaving ? "Saving…" : "Save snippet") {
                    Task { await save() }
                }
